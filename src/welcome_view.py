...
class WelcomeView:
    ...
    def _initialize(self):
        ...
        self.button_sweet.grid(row=2, column=1, columnspan=1, sticky=(constants.E, constants.W), padx=10, pady=10)
        self.button_salty.grid(row=2, column=0, columnspan=1, sticky=(constants.E, constants.W), padx=10, pady=10)
        self.button_ok.grid(columnspan=2, row=3, sticky=(constants.E, constants.W), padx=10, pady=10)
